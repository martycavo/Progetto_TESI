function [Position] = find_alignment_of_memorized_vertex(V1,V2,V3)
%
% [Position] =  = find_alignment_of_memorized_vertex(V1,V2,V3)
%
...
%           not
% V1,V2,V3 : the verteces to control

global V
global tolerance

Position = ( V(V2,2)*( V(V1,1)-V(V3,1) ) + V(V3,2)*( V(V2,1)-V(V1,1) )  + V(V1,2)*( V(V3,1)-V(V2,1) ) );
