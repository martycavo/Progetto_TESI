...
% bbtrflip (*see attachments) algorithm to transform the grid into a Delaunay
...
if BInfo(Border,2) == 1; %in this case the border is a boundary border
    ...
    % Flip actual grid
    bbtrflip (NewTriangle1,Neighbour1,Border1);
    bbtrflip (NewTriangle2,Neighbour2,Border2);
    ...
    % Flip actual grid
    bbtrflip (NewTriangle11,Neighbour11,Border11);
    bbtrflip (NewTriangle12,Neighbour12,Border12);
    bbtrflip (NewTriangle23,Neighbour23,Border23);
    bbtrflip (NewTriangle24,Neighbour24,Border24);
